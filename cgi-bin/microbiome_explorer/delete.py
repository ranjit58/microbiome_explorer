...
cursor = db.cursor()
sql = "SELECT DISTINCT run_id FROM samples ORDER BY run_id DESC"
cursor.execute(sql)
...
<form class="form-inline" action="/cgi-bin/microbiome_explorer/delete_run.py" method="post">

           
   
 <br>                                 
&nbsp;&nbsp;&nbsp;&nbsp;Delete data by run:&nbsp;&nbsp;&nbsp;&nbsp;<select name="run">
'''
